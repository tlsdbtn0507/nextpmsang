...
/*
============================================================
⚠️ 사주 계산 알고리즘 동결(Freeze) 구간
이 파일의 계산 로직(getDayPillar/getMonthPillar/adjustForTimezone 등)
또는 상수를 변경하면 결과값이 달라질 수 있습니다.
변경 전 반드시 다음을 지키세요:
1) 변경 목적과 기대 영향(예: 특정 날짜의 일주 변화) 명시
2) 로컬/배포 환경 일관성(UTC 고정) 보장 여부 확인
3) 관련 테스트 추가/갱신 및 통과
============================================================
*/
